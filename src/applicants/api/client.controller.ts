...
import { GetClientsDto } from '../application/dtos/queries/get-clients.dto';
...
export class ClientController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Get All repositories of Github by Client Id',
    type: String,
    isArray: true,
  })
  async getAllRepositories(
    ...
    try {
      const result: Result<AppNotification, string[]> =
        await this.clientsApplicationService.getAllRepositoriesById(id);
